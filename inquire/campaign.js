...
let api = String('https://api.steinhq.com/v1/storages/5f6c08c75d3cdc44fcd7d504/campaignGeneral?search={"id":"' + id + '"}')
console.log(api);
...
function dataFill(json) {
	...
	document.getElementById('campaignName').value = json[0].campaignName;
	document.getElementById('promotedProduct').value = json[0].promotedProduct;

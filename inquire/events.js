...
let api = String('https://api.steinhq.com/v1/storages/5f6c08c75d3cdc44fcd7d504/events?search={"id":"' + id + '"}')
// console.log(api);
...
function dataFill(json) {
	...
	document.getElementById('eventName').value = json[0].eventName;
	document.getElementById('taggingType').value = json[0].taggingType;

...
let newNavGold = document.createElement('div');

// create the sticky btn and modal component
newNavGold.innerHTML = `
  <h6 class=""><a class="nav-link gsBold font-white btn shadow inqSm-Gold" style="background-color:#cc942c; color: #ffffff;" data-toggle="modal" data-target="#inquireform">Inquire Now!</a></h6>
  <h6 class="ml-5"><a class="nav-link mt-2 gsBold font-white btn sticky-top shadow"
  style="background-color:#cc942c; color: #ffffff;" data-toggle="modal" data-target="#inquireform">Inquire Now!</a></h6>
...
document.getElementById('newNavGoldSetLG').appendChild(newNavGold);
document.getElementById('newNavGoldSetSM').appendChild(newNavGold);

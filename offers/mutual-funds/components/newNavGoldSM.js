        ...
        <div role="document">
          <form action="https://rampver.com//mfinquiry-needhelp/#wpcf7-f12057-o1" method="post">
            ...
            <input type="hidden" name="campaignTitleEntry" id="campaignTitleEntry"/>
					<input type="hidden" name="promotedFund" id="promotedFundSM" />
					<input type="hidden" name="otherTags" id="otherTagsSM" />
            ...
            <div class="text-center mt-4 mb-4">
              <input type="submit" id="trigger" value="I want to invest!"
                class="text-white btn rfbtn font-weight-bold btn-lg" onclick="submitDetailsSM()" />
              <br />

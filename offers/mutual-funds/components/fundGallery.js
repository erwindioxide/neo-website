...
<div class="card h-100">
  ...
  <div class="my-1 mx-3 mt-2">
    ...
    <div class="mt-2"></div>
    <small class="mt-2" class="gs">🛡️ For {{riskprofile}}-type investors.</small>
    <br>
    <small class="gs">✔️ Min. initial investment is {{initial}}.</small>
    <br>
    <small class="gs">✔️ Min. additional investment is {{additional}}.</small>
    <br>
    <div class="mt-2"></div>
    <small class="claimHeader mt-3">This fund is for you if:</small>
    <br>
    <p class="text-justify mt-1 gs">
          ...
          <div class="mb-3">
            ...
            <div class="my-2 mx-3">
              ...
              <div>
                ...
                <hr>
                <small class="gs">🛡️ For {{riskprofile}}-type investors.</small>
                <br>
                <small class="gs">🕒 Recommended time horizon is {{timehorizon}}.</small>
                <br>
                <small class="gs">✔️ Minimum initial investment is {{initial}}.</small>
                <br>
                <small class="gs mb-2">✔️ Minimum additional investment is {{additional}}.</small>
                <br>
                <br>
                <small class="claimHeader mt-2">📝 Fund Description</small>
                <hr>
                <small class="gs text-justify">{{introduction}}</small>
                <br>
                <br>
                <small class="claimHeader mt-2">📑 This fund is for you if:</small>
                <hr>
                <ul>
                  <li>
                    <p class="text-justify mt-2">
                      <small style="text-align: justify" class="gs">{{ffy1}}</small>
                    </p>
                  </li>
                  <li>
                    <p class="text-justify mt-2">
                      <small style="text-align: justify" class="gs">{{ffy2}}</small>
                    </p>
                  </li>
                  <li>
                    <p class="text-justify mt-2">
                      <small style="text-align: justify" class="gs">{{ffy3}}</small>
                    </p>
                  </li>
                </ul>
              </div>

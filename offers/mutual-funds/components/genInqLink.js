...
<a href="" class="mx-auto btn btn-lg rfbtn text-white my-3 gsBold" data-toggle="modal" data-target="#inquireform">Start Investing!</a>
</div>
  <div class="modal fade" id="inquireform" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content gs">
...
setTimeout(function load() {
  ...
  document.getElementById('promotedFund').value = "New Rampver Website";

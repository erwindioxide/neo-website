...
function getUrlVars() {
  ...
  if (vars == {}) {
    window.location.href = 'https://rampver.com/response/404.html';
  } else {
    return vars;
  }
}
...
function dataFill(json) {
  document.querySelector('meta[property="og:title"]').setAttribute('content','Rampver Financials | ' + json[0].fundname) ;
  document.querySelector('meta[property="og:description"]').setAttribute('content',json[0].description) ;
  document.querySelector('meta[property="og:image"]').setAttribute('content', json[0].imageurl);
  ...
  document.getElementById('fundLogo').src = json[0].fundLogo;
  ...
  document.getElementById('vidLink').setAttribute('src', json[0].vidLink);
  ...
  document.getElementById('rfoReady').alt = json[0].rfoReady;
  document.getElementById('soafundname').value = json[0].fundname;
  document.getElementById('guidelines').value = json[0].guidelinespdf;
  document.getElementById('fundnamevalueSM').value = json[0].fundname;
  document.getElementById('prospectusSM').value = json[0].prospectuslink;
  document.getElementById('ffsSM').value = json[0].ffslink;
  document.getElementById('initialamtSM').value = json[0].initial;
  document.getElementById('additionalamtSM').value = json[0].additional;
  document.getElementById('urlGetSM').value = document.referrer;
  document.getElementById('imgGetSM').value = json[0].imageurl;
  document.getElementById('suitabilitySM').value = json[0].riskprofile;
  document.getElementById('intro_emailSM').value = json[0].introduction;
  document.getElementById('reason1SM').value = json[0].ffy1;
  document.getElementById('reason2SM').value = json[0].ffy2;
  document.getElementById('reason3SM').value = json[0].ffy3;
  document.getElementById('inquireModal').innerHTML = json[0].fundname;
  document.getElementById('inquireModalSM').innerHTML = json[0].fundname;
